<x-default-layout title="Major" section_title="Majors">
    @if (session('success'))
        <div class="bg-green-50 border-green-500 text-green-500 px-3 py-2">
            {{ session('success') }}
        </div>
    @endif
    <div class="flex">
        ...
        <table class="min-w-full bg-white shadow">
            <thead>
                <tr class="border-b border-zinc-200 text-sm leading-normal">
                    ...
                    <th class="py-3 px-6 text-left">Major Code</th>
                ...
                <tr class="border-b border-zinc-200 hover:bg-zinc-100">
                    ...
                    <td class="py-3 px-6 text-center">
                        ...
                        <form action="{{ route('majors.destroy', $major->id) }}" method="POST" class="inline-block">
                            @csrf
                            @method('DELETE')
                            <button onclick="return confirm('Are you sure?')" class="bg-red-50 border border-red-500 p-2">
